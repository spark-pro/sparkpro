                      ...
                      {apps.map(app => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td style={tdStyle}>
                              {app.resumeFilename
                                ? <a href={`/api/admin/resume/${app.resumeFilename}`} target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', color: '#4DC8E8', fontSize: '0.8125rem', textDecoration: 'none' }}><Download size={13} /> Download</a>
